import { UserPlus, MessageSquare, FileCheck, UserCheck } from "lucide-react";
  ...
  return (
    <section className="py-20 px-6 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-16 bg-gradient-section rounded-3xl p-8 md:p-12 shadow-soft">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {groups.map((group, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl shadow-soft hover:shadow-medium transition-smooth overflow-hidden border-2 border-transparent hover:border-primary/20"
            >
        ...
        {/* Case study */}
        <div className="bg-gradient-section rounded-3xl shadow-medium p-8 md:p-12 mb-12">
